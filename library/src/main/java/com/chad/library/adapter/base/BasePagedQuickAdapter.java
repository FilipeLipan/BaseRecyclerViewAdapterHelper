...
public abstract class BasePagedQuickAdapter<T, K extends BaseViewHolder> extends PagedListAdapter<T, K> implements IBaseViewHolderAdapter {
     ...
     */
    public BasePagedQuickAdapter(@LayoutRes int layoutResId, @NonNull DiffUtil.ItemCallback<T> diffCallback) {
        super(diffCallback);
        if (layoutResId != 0) {
    ...
    private void compatibilityDataSizeChanged(int size) {
        final int dataSize = super.getCurrentList() == null ? 0 : super.getItemCount();
        if (dataSize == size) {
    ...
    public void setOnItemClick(View v, int position) {
        getOnItemClickListener().onItemClick(BasePagedQuickAdapter.this, v, position);
    }
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(BasePagedQuickAdapter.this, v, position);
    }
