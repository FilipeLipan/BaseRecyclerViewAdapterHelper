...
import com.chad.library.adapter.base.DoubledBaseViewHolder;
import com.chad.library.adapter.base.DoubledBaseViewHolder;
...
public abstract class DoubleLoadMoreView {
    ...
    public void convert(DoubledBaseViewHolder holder) {
    ...
    private void visibleLoading(DoubledBaseViewHolder holder, boolean visible) {
        holder.setGone(getLoadingViewId(), visible);
    }

    private void visibleLoadFail(DoubledBaseViewHolder holder, boolean visible) {
        holder.setGone(getLoadFailViewId(), visible);
    }

    private void visibleLoadEnd(DoubledBaseViewHolder holder, boolean visible) {
